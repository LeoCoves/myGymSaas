...
namespace ApiFithub.Migrations
{
    ...
    [Migration("20250413141612_RemoveUniqueIndexFromIdClient")]
    partial class RemoveUniqueIndexFromIdClient
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiFithub.Models.Client", b =>
                {
                    ...
                    b.Property<DateTime>("FirstDayInscription")
                        .HasColumnType("datetime2");

                    b.Property<int?>("GymCustomPaymentPlansIdGymCustomPaymentPlan")
                        .HasColumnType("int");

                    b.Property<int?>("GymsIdGym")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GymCustomPaymentPlansIdGymCustomPaymentPlan");

                    b.HasIndex("GymsIdGym");
            ...
            modelBuilder.Entity("ApiFithub.Models.Inscription", b =>
                {
                    ...
                    b.HasIndex("IdGymCustomPaymentPlan");
            ...
            modelBuilder.Entity("ApiFithub.Models.Client", b =>
                {
                    ...
                    b.HasOne("ApiFithub.Models.GymCustomPaymentPlan", "GymCustomPaymentPlans")
                        .WithMany()
                        .HasForeignKey("GymCustomPaymentPlansIdGymCustomPaymentPlan");

                    b.HasOne("ApiFithub.Models.Gym", "Gyms")
                        .WithMany()
                        .HasForeignKey("GymsIdGym");
            ...
            modelBuilder.Entity("ApiFithub.Models.GymCustomPaymentPlan", b =>
                {
                    b.HasOne("ApiFithub.Models.Gym", null)
                        .WithMany("GymCustomPaymentPlans")
                        .HasForeignKey("GymIdGym");
            ...
            modelBuilder.Entity("ApiFithub.Models.Inscription", b =>
                {
                    ...
                    b.HasOne("ApiFithub.Models.GymCustomPaymentPlan", "GymCustomPaymentPlan")
                        .WithMany()
                        .HasForeignKey("IdGymCustomPaymentPlan")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
